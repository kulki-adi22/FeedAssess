...
public class Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String msg = "Subject feedback not added! Please contact admin";
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (usnText.getText().toString().equals(""))
                    ...
                    if (subjects.getSelectedItem().toString().equals("Choose a subject"))
                        Toast.makeText(getApplicationContext(), "Please choose subject", Toast.LENGTH_SHORT).show();
                    else
                        getData();
                }
    ...
    private int checkSubject() {
        int flag = 0;
        String questions = db.collection("Questions").getId();
        String temp = "";
        ...
        for (int i = 0; i < list.size(); i++) {
            temp = list.get(i);
            if (selectedSubject.equals(temp))
                flag = 1;
        }
